        ...
        <div className="row form-row">
          <div className="col-md-6">
            <div className="box box-primary">
              {/* form start */}
              <Formik
                initialValues={supplierValues(profile)}
                validationSchema={validateSupplierForm}
                onSubmit={onSubmit}
                enableReinitialize
              >
                {() => (
...
const mapDispatchToProps = (dispatch) => ({
  addSupplier: (values) => dispatch(actions.addSupplier(values)),
  editSupplier: (values, id) => dispatch(actions.editSupplier(values, id)),
  getSupplierProfile: (id) => dispatch(actions.getSupplierProfile(id)),
});
