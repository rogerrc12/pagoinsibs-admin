...
import { addPaymentToBank, getAccPaymentDetail } from '../../../../actions/payments';
        ...
        <>
          <div className="row invoice-info">
            ...
            <div className="col-sm-4 invoice-col">
              ...
              <b>Monto:</b>
              {' '}
              {Number(detail.amount).toLocaleString('es-ES', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              {' '}
              Bs.
              <br />
              <b>Descripción:</b>
