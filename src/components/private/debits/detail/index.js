...
const DebitDetail = withRouter(
  ({ getDebitDetail, addDebitToBank, detail, match, loading, cancelDebit }) => {
      ...
      detail.user ?
        <section className='invoice'>
            ...
            <div className='col-xs-12'>
              <h2 className='page-header'>
                ...
                <small className='pull-right'>
                  <Moment format='DD/MM/YYYY [a las] hh:mm a'>
                    {detail.createdAt}
                  </Moment>
                </small>
              </h2>
          ...
          <div className='row invoice-info'>
            ...
            <div className='col-sm-4 invoice-col'>
              ...
              <Link
                ...
                to={`/users-payments/profile/${detail.supplier.id}`}>
          ...
          <div className='row no-print'>
            <div className='col-xs-12'>
              <button type='button' className='btn btn-danger pull-right' onClick={() => cancelDebit(detail.id)}
                      disabled={ detail.status.name === "fallido" || detail.status.name === "cancelado" }>
                Cancelar <i className='fa fa-times'/>
              </button>
              <button
                type='button'
                onClick={() => addDebitToBank(id)}
