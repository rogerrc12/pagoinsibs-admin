...
import { getBankPayments, generateCiserFile, uploadSiserFile } from '../../../actions/bankPayments';
// SWEETALERT
...
const MercantilPayment = withRouter(({ getBankPayments, bank_payments, generateCiserFile, uploadSiserFile, loading, history }) => {
  ...
  const showSiserInputFile = () => MySwal.fire({
    html:
          ...
          <Form className="form-upload-file">
            ...
            <div className="input-group input-group-file">
              <div className="input-group-addon">
                <input type="file" id="siser-file" accept=".xls, .xlsx"
                       onChange={e => {
                ...
                />
                <label htmlFor="siser-file" className="file-upload-label">Cargar archivo</label>
              </div>
              <span className="input-file-text" ref={fileTextRef}>No hay archivo...</span>
            </div>
            <button type="submit" className={`btn btn-primary ld-ext-right ${loading && 'running'}`}
              disabled={loading}
            >
              Procesar archivo
  ...
  const SectionHeader = () => (
    <section className='content-header'>
      ...
      <div className="content__button-action">
        ...
        <button className={`btn btn-warning ld-ext-right ${loading && 'running'}`} disabled={loading}
